...
.NO_PARALLEL:${OBJECTDIR}/Practica\ 6.o
${OBJECTDIR}/Practica\ 6.o: Practica\ 6.2
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Practica\ 6.o Practica\ 6.2
